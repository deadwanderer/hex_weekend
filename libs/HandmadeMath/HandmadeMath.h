...
typedef union hmm_mat4 {
  ...
  HMM_DEPRECATED(
      "Our matrices are column-major, so this was named incorrectly. Use "
      "Columns instead.")
  __m128 Rows[4];
#endif
...
#ifdef HANDMADE_MATH__USE_SSE
  Result.InternalElementsSSE =
      _mm_setr_ps((float)X, (float)Y, (float)Z, (float)W);
#else
  Result.X = (float)X;
  Result.Y = (float)Y;
  Result.Z = (float)Z;
...
#ifdef HANDMADE_MATH__USE_SSE
  Result.InternalElementsSSE =
      _mm_add_ps(Left.InternalElementsSSE, Right.InternalElementsSSE);
#else
  Result.X = Left.X + Right.X;
  Result.Y = Left.Y + Right.Y;
  Result.Z = Left.Z + Right.Z;
...
#ifdef HANDMADE_MATH__USE_SSE
  Result.InternalElementsSSE =
      _mm_sub_ps(Left.InternalElementsSSE, Right.InternalElementsSSE);
#else
  Result.X = Left.X - Right.X;
  Result.Y = Left.Y - Right.Y;
  Result.Z = Left.Z - Right.Z;
...
#ifdef HANDMADE_MATH__USE_SSE
  Result.InternalElementsSSE =
      _mm_mul_ps(Left.InternalElementsSSE, Right.InternalElementsSSE);
#else
  Result.X = Left.X * Right.X;
  Result.Y = Left.Y * Right.Y;
  Result.Z = Left.Z * Right.Z;
...
#ifdef HANDMADE_MATH__USE_SSE
  Result.InternalElementsSSE =
      _mm_div_ps(Left.InternalElementsSSE, Right.InternalElementsSSE);
#else
  Result.X = Left.X / Right.X;
  Result.Y = Left.Y / Right.Y;
  Result.Z = Left.Z / Right.Z;
...
HMM_INLINE hmm_vec4 HMM_PREFIX(NormalizeVec4)(hmm_vec4 A) {
  ...
  if (VectorLength != 0.0f) {
    ...
    Result.InternalElementsSSE =
        _mm_mul_ps(A.InternalElementsSSE, SSEMultiplier);
#else
...
HMM_INLINE hmm_vec2 HMM_PREFIX(FastNormalizeVec2)(hmm_vec2 A) {
  ...
  return HMM_PREFIX(MultiplyVec2f)(
      A, HMM_PREFIX(RSquareRootF)(HMM_PREFIX(DotVec2)(A, A)));
}
...
HMM_INLINE hmm_vec3 HMM_PREFIX(FastNormalizeVec3)(hmm_vec3 A) {
  ...
  return HMM_PREFIX(MultiplyVec3f)(
      A, HMM_PREFIX(RSquareRootF)(HMM_PREFIX(DotVec3)(A, A)));
}
...
HMM_INLINE hmm_vec4 HMM_PREFIX(FastNormalizeVec4)(hmm_vec4 A) {
  ...
  return HMM_PREFIX(MultiplyVec4f)(
      A, HMM_PREFIX(RSquareRootF)(HMM_PREFIX(DotVec4)(A, A)));
}
...
HMM_INLINE __m128 HMM_PREFIX(LinearCombineSSE)(__m128 Left, hmm_mat4 Right) {
  ...
  Result = _mm_add_ps(
      Result, _mm_mul_ps(_mm_shuffle_ps(Left, Left, 0x55), Right.Columns[1]));
  Result = _mm_add_ps(
      Result, _mm_mul_ps(_mm_shuffle_ps(Left, Left, 0xaa), Right.Columns[2]));
  Result = _mm_add_ps(
      Result, _mm_mul_ps(_mm_shuffle_ps(Left, Left, 0xff), Right.Columns[3]));
...
HMM_INLINE hmm_mat4 HMM_PREFIX(Transpose)(hmm_mat4 Matrix) {
  ...
  _MM_TRANSPOSE4_PS(Result.Columns[0], Result.Columns[1], Result.Columns[2],
                    Result.Columns[3]);
...
HMM_DEF hmm_vec4 HMM_PREFIX(MultiplyMat4ByVec4)(hmm_mat4 Matrix,
                                                hmm_vec4 Vector);
...
HMM_INLINE hmm_mat4 HMM_PREFIX(Orthographic)(float Left,
                                             float Right,
                                             float Bottom,
                                             float Top,
                                             float Near,
...
HMM_INLINE hmm_mat4 HMM_PREFIX(Perspective)(float FOV,
                                            float AspectRatio,
                                            float Near,
                                            float Far) {
...
HMM_INLINE hmm_quaternion HMM_PREFIX(Quaternion)(float X,
                                                 float Y,
                                                 float Z,
                                                 float W) {
...
HMM_INLINE hmm_quaternion HMM_PREFIX(AddQuaternion)(hmm_quaternion Left,
...
HMM_INLINE hmm_quaternion HMM_PREFIX(SubtractQuaternion)(hmm_quaternion Left,
                                                         hmm_quaternion Right) {
...
HMM_INLINE hmm_quaternion HMM_PREFIX(MultiplyQuaternion)(hmm_quaternion Left,
                                                         hmm_quaternion Right) {
  ...
  __m128 SSEResultOne = _mm_xor_ps(
      _mm_shuffle_ps(Left.InternalElementsSSE, Left.InternalElementsSSE,
                     _MM_SHUFFLE(0, 0, 0, 0)),
      _mm_setr_ps(0.f, -0.f, 0.f, -0.f));
  __m128 SSEResultTwo =
      _mm_shuffle_ps(Right.InternalElementsSSE, Right.InternalElementsSSE,
                     _MM_SHUFFLE(0, 1, 2, 3));
...
HMM_INLINE hmm_quaternion
HMM_PREFIX(MultiplyQuaternionF)(hmm_quaternion Left, float Multiplicative) {
...
HMM_INLINE hmm_quaternion HMM_PREFIX(DivideQuaternionF)(hmm_quaternion Left,
                                                        float Dividend) {
...
HMM_INLINE float HMM_PREFIX(DotQuaternion)(hmm_quaternion Left,
                                           hmm_quaternion Right) {
...
HMM_INLINE hmm_quaternion HMM_PREFIX(NLerp)(hmm_quaternion Left,
                                            float Time,
                                            hmm_quaternion Right) {
...
HMM_DEF hmm_quaternion HMM_PREFIX(Slerp)(hmm_quaternion Left,
                                         float Time,
                                         hmm_quaternion Right);
...
HMM_DEF hmm_quaternion
    HMM_PREFIX(QuaternionFromAxisAngle)(hmm_vec3 Axis, float AngleOfRotation);
...
HMM_INLINE float HMM_PREFIX(Dot)(hmm_quaternion QuatOne,
                                 hmm_quaternion QuatTwo) {
...
HMM_INLINE hmm_quaternion HMM_PREFIX(Add)(hmm_quaternion Left,
                                          hmm_quaternion Right) {
...
HMM_INLINE hmm_quaternion HMM_PREFIX(Subtract)(hmm_quaternion Left,
                                               hmm_quaternion Right) {
...
HMM_INLINE hmm_quaternion HMM_PREFIX(Multiply)(hmm_quaternion Left,
                                               hmm_quaternion Right) {
...
HMM_INLINE hmm_quaternion& operator+=(hmm_quaternion& Left,
                                      hmm_quaternion Right) {
...
HMM_INLINE hmm_vec4 operator-(hmm_vec4 In) {
  ...
  Result.InternalElementsSSE =
      _mm_xor_ps(In.InternalElementsSSE, _mm_set1_ps(-0.0f));
  #else
  Result.X = -In.X;
  Result.Y = -In.Y;
  Result.Z = -In.Z;
...
#ifdef HANDMADE_MATH__USE_SSE
  Result.InternalElementsSSE =
      HMM_PREFIX(LinearCombineSSE)(Vector.InternalElementsSSE, Matrix);
#else
  int Columns, Rows;
  for (Rows = 0; Rows < 4; ++Rows) {
    float Sum = 0;
...
hmm_quaternion HMM_PREFIX(Slerp)(hmm_quaternion Left,
                                 float Time,
                                 hmm_quaternion Right) {
...
hmm_quaternion HMM_PREFIX(Mat4ToQuaternion)(hmm_mat4 M) {
  ...
  if (M.Elements[2][2] < 0.0f) {
    if (M.Elements[0][0] > M.Elements[1][1]) {
      ...
      Q = HMM_PREFIX(Quaternion)(T, M.Elements[0][1] + M.Elements[1][0],
      ...
      T = 1 - M.Elements[0][0] + M.Elements[1][1] - M.Elements[2][2];
      Q = HMM_PREFIX(Quaternion)(M.Elements[0][1] + M.Elements[1][0], T,
                                 M.Elements[1][2] + M.Elements[2][1],
                                 M.Elements[2][0] - M.Elements[0][2]);
    }
  } else {
    if (M.Elements[0][0] < -M.Elements[1][1]) {
      ...
      T = 1 - M.Elements[0][0] - M.Elements[1][1] + M.Elements[2][2];
      Q = HMM_PREFIX(Quaternion)(M.Elements[2][0] + M.Elements[0][2],
      ...
      T = 1 + M.Elements[0][0] + M.Elements[1][1] + M.Elements[2][2];
      Q = HMM_PREFIX(Quaternion)(M.Elements[1][2] - M.Elements[2][1],
                                 M.Elements[2][0] - M.Elements[0][2],
...
hmm_quaternion HMM_PREFIX(QuaternionFromAxisAngle)(hmm_vec3 Axis,
